...
def show_documentation_panel():
    ...
    try:
        ...
        doc_content = "⚠️ DOCUMENTATION.md file not found!"
    ...
    <style>
        ...
        .doc-body h1:first-child, .doc-body h2:first-child, .doc-body h3:first-child {
            margin-top: 0;
        }
        .doc-body h4 {
            color: #c4b5fd;
    ...
    # Display documentation in styled container
    st.markdown('<div class="doc-container"><div class="doc-header-bar"><h2>📚 Complete Documentation</h2></div><div class="doc-body">', unsafe_allow_html=True)
